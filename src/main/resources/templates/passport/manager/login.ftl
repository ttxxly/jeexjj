                            ...
                            <div class="form-bottom">
			                    <form id="loginForm">
			                    	<div class="form-group">
			                        	...
			                        	<input type="text" id="loginName" name="loginName" placeholder="请输入账号" value="admin" class="form-username form-control" id="form-username">
			                        </div>
			                        <div class="form-group">
			                        	<label class="sr-only" for="form-password">Password</label>
			                        	<input type="password" id="password" name="password" value="123456" placeholder="请输入密码" class="form-password form-control" id="form-password">
			                        </div>
